...
uint8 QRCode_received = 0,QRCode_existed = 0,Quick_Second = 0;
...
uint16 Record_Max_Postion[8] = {0},Action_time = 0;
uint16 UI_WindowBlocks = 0,Power_Second = 0,Power_Minute = 0;
uint16 reagent_Strip[4] = {0},SignalProcess_sampleBuffer[1024] = {0};
